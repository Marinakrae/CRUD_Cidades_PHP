        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="cadastrarCidade.php">Cadastrar</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <form method="post" action="controleCidade.php">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o nome da cidade">
            </div>
            <div class="mb-3">
